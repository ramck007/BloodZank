...
String dummy=request.getParameter("BloodGroup");
<h3 style="color: yellow;">Product ID: <%out.println("dummy"); %> </h3>
...
String sql =null;
//String sql="select name,number from bloodzank where bloodgrp='"+dummy+"';";
...
//String sql1 ="SELECT * FROM bloodzank";
...
<script>
        function GetDonor(){
            ...
            document.getElementById("dumm").innerHTML=bg;
            console.log(bg);
            console.log(loc);
